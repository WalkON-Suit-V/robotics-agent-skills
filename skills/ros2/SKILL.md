...
description: Use when building ROS2 packages or nodes, configuring colcon workspaces, tuning DDS/QoS settings, writing launch files, using lifecycle or component nodes, working with nav2 or MoveIt2, or troubleshooting ROS2 build errors
---
